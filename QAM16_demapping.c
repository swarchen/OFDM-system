...
int main(int argc, const char * argv[]) {
    ...
    for (int i = 0; i < Num/bit; i ++) {
        if (x_Re[i] < -two && x_Im[i] < -two) {
            fprintf(fout,"0 0 0 0 ");
        }else if (x_Re[i] < -two && x_Im[i] >= -two && x_Im[i] < 0) {
            fprintf(fout,"0 0 0 1 ");
        }else if (x_Re[i] < -two && x_Im[i] >= two) {
            fprintf(fout,"0 0 1 0 ");
        }else if (x_Re[i] < -two && x_Im[i] < two && x_Im[i] >= 0) {
            fprintf(fout,"0 0 1 1 ");
        }else if (x_Re[i] < 0 && x_Re[i] >= -two && x_Im[i] < -two) {
            fprintf(fout,"0 1 0 0 ");
        }else if (x_Re[i] < 0 && x_Re[i] >= -two && x_Im[i] >= -two && x_Im[i] < 0) {
            fprintf(fout,"0 1 0 1 ");
        }else if (x_Re[i] < 0 && x_Re[i] >= -two && x_Im[i] >= two) {
            fprintf(fout,"0 1 1 0 ");
        }else if (x_Re[i] < 0 && x_Re[i] >= -two && x_Im[i] < two && x_Im[i] >= 0) {
            fprintf(fout,"0 1 1 1 ");
        }else if (x_Re[i] >= two && x_Im[i] < -two) {
            ...
            fprintf(fout,"1 0 1 1 ");
        }else if (x_Re[i] >= 0 && x_Re[i] < two && x_Im[i] < -two) {
            fprintf(fout,"1 1 0 0 ");
        }else if (x_Re[i] >= 0 && x_Re[i] < two && x_Im[i] >= -two && x_Im[i] < 0) {
            fprintf(fout,"1 1 0 1 ");
        }else if (x_Re[i] >= 0 && x_Re[i] < two && x_Im[i] >= two) {
            fprintf(fout,"1 1 1 0 ");
        }else{
